...
# Apply custom CSS for green radio button selection dots and slider styling
st.markdown("""
    <style>
        ...
        /* Force green slider styling for WebKit browsers */
        ...
        /* Force green slider styling for Firefox */
